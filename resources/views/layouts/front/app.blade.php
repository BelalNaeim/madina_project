        ...
        <div id="top_line">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-6">
                        <ul id="top_links">
                            <li><a href="#" class="icon-facebook">فيس بوك</a></li>
                            <li><a href="https://twitter.com/med_projects" target="_blank"
                                    class="icon-twitter">تويتر</a></li>
                            <li><a href="https://www.instagram.com/med_projects/" target="_blank"
                                    class="icon-instagram">انستغرام</a></li>
                            <li><a href="https://www.youtube.com/channel/UCJX-KrW5obRLs6xVrFgcpWQ" target="_blank"
                                    class="icon-youtube-play">يوتيوب</a></li>
                        </ul>
                    </div>
                </div><!-- End row -->
            </div><!-- End container-->
